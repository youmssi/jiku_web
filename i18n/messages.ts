 ...
 */
export const NAMESPACES = ["common", "auth", "shell", "events", "services", "guests", "feedback", "guest", "billing", "settings", "operator", "admin"] as const;
...
export interface Messages {
  ...
  admin: typeof import("../messages/fr/admin.json");
}
